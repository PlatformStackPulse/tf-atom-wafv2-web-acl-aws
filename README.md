...
[![CI](https://github.com/PlatformStackPulse/tf-atom-wafv2-web-acl-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-web-acl-aws/actions/workflows/ci.yml)
[![Release](https://github.com/PlatformStackPulse/tf-atom-wafv2-web-acl-aws/actions/workflows/auto-release.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-web-acl-aws/actions/workflows/auto-release.yml)
[![CodeQL](https://github.com/PlatformStackPulse/tf-atom-wafv2-web-acl-aws/actions/workflows/codeql.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-web-acl-aws/actions/workflows/codeql.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-wafv2-web-acl-aws)](https://github.com/PlatformStackPulse/tf-atom-wafv2-web-acl-aws/releases)

---

## Purpose

Terraform atom module for a single AWS WAFv2 Web ACL resource. Provides a web application firewall access control list with configurable default action, rules, and visibility configuration.
...
| <a name="input_rules"></a> [rules](#input\_rules) | List of rule configurations for the Web ACL. | `list(any)` | `[]` | no |
...
| <a name="output_web_acl_capacity"></a> [web\_acl\_capacity](#output\_web\_acl\_capacity) | The web ACL capacity units (WCU) currently being used. |
